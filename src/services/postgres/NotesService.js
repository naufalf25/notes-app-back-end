  ...
  async getNotes(owner) {
    try {
      ...
      const query = {
        ...
        LEFT JOIN collaborations ON collaborations.note_id = notes.id WHERE notes.owner = $1 OR collaborations.user_id = $1 GROUP BY notes.id`,
        values: [owner],
      };
      const result = await this._pool.query(query);
      ...
      this._cacheService.set(`notes:${owner}`, JSON.stringify(mappedResult));
